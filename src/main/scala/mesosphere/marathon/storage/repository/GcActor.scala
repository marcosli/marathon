...
private[storage] class GcActor[K, C, S](
  ...
  private var totalGcs = Kamon.metrics.counter("GarbageCollector.totalGcs")
  private var lastScanStart = Instant.now()
  private var scanTime = Kamon.metrics.histogram("GarbageCollector.scanTime", Time.Milliseconds)
  private var lastCompactStart = Instant.now()
  private var compactTime = Kamon.metrics.histogram("GarbageCollector.compactTime", Time.Milliseconds)
